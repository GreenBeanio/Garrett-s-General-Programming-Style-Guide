...
You will find many who will say things along the lines of "code should be self-documenting and shouldn't use comments." I do not agree. I believe that code should have as many comments as needed. Even if it is what many would probably consider to be too many comments. Code should be "self-documenting" in the sense that if follows naming conventions, uses descriptive names, structured programming, consistency, small components, etc. However, I believe that very rarely will a comment truly deter much readability. On the contrary, a comment will more often than not add insight into the code itself or the programmer's reasoning or mindset. What may be clear in the code to you now may not be in a month, year, or even a day. The code may also not be clear to the next maintainer or user of the codebase. For these reasons I believe that comments should be used extensively.
...
Names that you use should be readable, descriptive, and clear to what they do or mean.
...
I should note that despite my deep hatred for GenAI I do have love for traditional machine learning, statistical learning, artificial intelligence, learning algorithms, and automation. My main qualms with GenAI stem moral, ethical, and personal reasons, as well as the general inefficiency and inaccuracy of the models compared to domain-specific models or even other general-purpose models.
